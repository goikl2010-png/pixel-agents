...
it('schema-v4 pins TASK-033 scope and exact Codex while preserving governance-first zero launch', async () => {
  const candidate = await fixture();
  Object.assign(candidate.config, {
    schema_version: '4',
    task_id: 'TASK-033',
    ...
    target_issue: 16,
    target_pr: 17,
    target_path: 'C:\\AI-Company\\tasks\\review\\codex-pixel-agents-033.md',
    executable: 'C:\\Users\\X1 CARBON\\AppData\\Roaming\\npm\\codex.cmd',
    approved_working_root: 'C:\\AI-Company',
    output_schema:
      'C:\\AI-Company\\.worktrees\\TASK-024-LIVE\\docs\\schemas\\company-runner-codex-output-v1.schema.json',
    state_directory: 'C:\\AI-Company\\.company-runner-state\\TASK-033',
    stop_file: 'C:\\AI-Company\\.company-runner-state\\TASK-033\\STOP',
    argument_template: [
      '--ask-for-approval',
      'on-request',
      'exec',
  ...
  Object.assign(candidate.authorization, {
    ...
    output_schema: candidate.config.output_schema,
    argument_template: candidate.config.argument_template,
    expected_effects: [...expectedEffectsForAuthorization('READY_FOR_QA', 'Pixel', 'TASK-033')],
  });
  const github = candidate.authorization.github as {
    issue: number;
    pr: number;
    draft: boolean;
    branch: string;
    scope: { commits: number; files: Array<{ path: string }> };
  };
  Object.assign(github, {
    issue: 16,
    pr: 17,
    draft: false,
    branch: 'task/TASK-033-runner-v1-activation-canary-003',
    scope: {
      commits: 1,
      additions: 8,
      deletions: 0,
      ...
      files: [
        {
          path: 'documentation/runner-v1-activation-canary-003.md',
          status: 'added',
          additions: 8,
          deletions: 0,
          changes: 8,
  ...
  for (const mutate of [
    ...
    (auth: typeof github) => {
      auth.branch = 'task/TASK-032-runner-v1-activation-canary-002';
    },
    (auth: typeof github) => {
      auth.scope.commits = 2;
    },
    (auth: typeof github) => {
      auth.scope.files[0].path = 'documentation/runner-v1-activation-canary-002.md';
    },
  ]) {
    const drifted = JSON.parse(validAuthorization) as typeof candidate.authorization;
    mutate(drifted.github as typeof github);
...
it('schema-v5 pins TASK-035 scope and exact Codex while preserving governance-first zero launch', async () => {
  const candidate = await fixture();
  Object.assign(candidate.config, {
    schema_version: '5',
    task_id: 'TASK-035',
    ...
    target_issue: 18,
    target_pr: 19,
    target_path: 'C:\\AI-Company\\tasks\\review\\codex-pixel-agents-035.md',
    executable: 'C:\\Users\\X1 CARBON\\AppData\\Roaming\\npm\\codex.cmd',
    approved_working_root: 'C:\\AI-Company',
    output_schema:
      'C:\\AI-Company\\.worktrees\\TASK-024-LIVE\\docs\\schemas\\company-runner-codex-output-v1.schema.json',
    state_directory: 'C:\\AI-Company\\.company-runner-state\\TASK-035',
    stop_file: 'C:\\AI-Company\\.company-runner-state\\TASK-035\\STOP',
    argument_template: [
      '--ask-for-approval',
      'on-request',
      'exec',
  ...
  Object.assign(candidate.authorization, {
    ...
    output_schema: candidate.config.output_schema,
    argument_template: candidate.config.argument_template,
    expected_effects: [...expectedEffectsForAuthorization('READY_FOR_QA', 'Pixel', 'TASK-035')],
  });
  const github = candidate.authorization.github as {
    issue: number;
    pr: number;
  ...
  Object.assign(github, {
    ...
    pr: 19,
    draft: false,
    branch: 'task/TASK-035-runner-v1-activation-canary-004',
    scope: {
      commits: 1,
      additions: 8,
      deletions: 0,
      ...
      files: [
        {
          path: 'documentation/runner-v1-activation-canary-004.md',
          status: 'added',
          additions: 8,
          deletions: 0,
          changes: 8,
  ...
  for (const mutate of [
    ...
    (auth: typeof candidate.authorization) => {
      (auth.github as { head: string }).head = 'e'.repeat(40);
    },
    (auth: typeof candidate.authorization) => {
      (auth.github as { branch: string }).branch = 'task/TASK-033-runner-v1-activation-canary-003';
    },
    (auth: typeof candidate.authorization) => {
      (auth.github as { scope: { files: Array<{ path: string }> } }).scope.files[0].path =
    ...
    await expect(
      ...
      /Schema-v5|Successor activation requires|Production (?:launch )?authorization/,
    );
    expect(rejectedCounters).toEqual({ github: 0, spawn: 0 });
  }
...
it('schema-v6 pins frozen TASK-037 Atlas scope while preserving governance-first zero launch', async () => {
  const candidate = await fixture();
  Object.assign(candidate.config, {
    schema_version: '6',
    task_id: 'TASK-037',
    ...
    target_issue: 20,
    target_pr: 21,
    target_path: 'C:\\AI-Company\\tasks\\review\\codex-pixel-agents-037.md',
    executable: 'C:\\Users\\X1 CARBON\\AppData\\Roaming\\npm\\codex.cmd',
    approved_working_root: 'C:\\AI-Company',
    output_schema:
      'C:\\AI-Company\\.worktrees\\TASK-024-LIVE\\docs\\schemas\\company-runner-codex-output-v1.schema.json',
    state_directory: 'C:\\AI-Company\\.company-runner-state\\TASK-037',
    stop_file: 'C:\\AI-Company\\.company-runner-state\\TASK-037\\STOP',
    argument_template: [
      '--ask-for-approval',
      'on-request',
      'exec',
  ...
  for (const mutate of [
    ...
    (auth: typeof candidate.authorization) => {
      (auth.github as { branch: string }).branch = 'task/TASK-035-runner-v1-activation-canary-004';
    },
    (auth: typeof candidate.authorization) => {
      (auth.github as { scope: { files: Array<{ path: string }> } }).scope.files[0].path =
    ...
    await expect(
      ...
      /Schema-v6|Successor activation requires|Production (?:launch )?authorization/,
    );
    expect(rejectedCounters).toEqual({ github: 0, spawn: 0 });
  }
